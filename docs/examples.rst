...
::
  ...
  # Create site tree
  mx = imperva_sdk.MxConnection(Host="10.100.46.138", Username="admin", Password="***REMOVED***") # Connect to MX
...
::
  ...
  # Connect to MX
  mx = imperva_sdk.MxConnection("10.100.73.151", Password="***REMOVED***")
