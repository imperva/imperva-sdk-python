...
class ServerGroup(MxObject):
  ...
  def create_db_service(self, Name=None, ServerGroup=None, Site=None, Ports=[], DefaultApp=None, DbMappings=[], TextReplacement=[], LogCollectors=[], DbConnections=[], SecurityPolicies=[], AuditPolicies=[], DbServiceType=None, update=False):
    return self._connection.create_db_service(Name=Name, ServerGroup=self.Name, Site=self._Site, Ports=Ports, DefaultApp=DefaultApp, DbMappings=DbMappings, TextReplacement=TextReplacement, LogCollectors=LogCollectors, DbConnections=DbConnections, SecurityPolicies=SecurityPolicies, AuditPolicies=AuditPolicies, DbServiceType=DbServiceType, update=update)
  def create_db_service_pc(self, Name=None, ServerGroup=None, Site=None, Ports=[], DefaultApp=None, DbMappings=[], TextReplacement=[], LogCollectors=[], DbConnections=[], SecurityPolicies=[], AuditPolicies=[], DbServiceType=None, update=False):
    return self._connection.create_db_service_pc(Name=Name, ServerGroup=self.Name, Site=self._Site, Ports=Ports, DefaultApp=DefaultApp, DbMappings=DbMappings, TextReplacement=TextReplacement, LogCollectors=LogCollectors, DbConnections=DbConnections, SecurityPolicies=SecurityPolicies, AuditPolicies=AuditPolicies, DbServiceType=DbServiceType, update=update)
