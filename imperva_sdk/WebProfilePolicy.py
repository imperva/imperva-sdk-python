...
class WebProfilePolicy(MxObject):
    ...
    def Rules(self):
        ...
        >>> pol.Rules
        [{'name': 'Cookie Injection', 'enabled': False, 'severity': 'medium', 'action': 'none'}, {'name': 'Cookie Tampering', 'enabled': True, 'severity': 'medium', 'action': 'none'}, {'name': 'Non-SOAP Access to a SOAP Only URL', 'enabled': False, 'severity': 'medium', 'act
ion': 'none'}, {'name': 'Parameter Read Only Violation', 'enabled': False, 'severity': 'informative', 'action': 'none', 'parameters': {'issueAnomalyForRequestsWithoutSession': 'false', 'issueAnomalyForCorrelatedParameterTampering': 'true', 'issueAnomalyForResponseEva
sion': 'true'}}, {'name': 'Parameter Type Violation', 'enabled': False, 'severity': 'medium', 'action': 'none'}, {'name': 'Parameter Value Length Violation', 'enabled': False, 'severity': 'informative', 'action': 'none'}, {'name': 'Required Parameter Not Found', 'ena
bled': False, 'severity': 'informative', 'action': 'none'}, {'name': 'Required XML Element Not Found', 'enabled': False, 'severity': 'informative', 'action': 'none'}, {'name': "Reuse of Expired Session's Cookie", 'enabled': False, 'severity': 'informative', 'action':
 'none'}, {'name': 'SOAP Access to a Non-SOAP URL', 'enabled': False, 'severity': 'medium', 'action': 'none'}, {'name': 'SOAP Element Value Length Violation', 'enabled': False, 'severity': 'informative', 'action': 'none'}, {'name': 'SOAP Element Value Type Violation'
, 'enabled': False, 'severity': 'medium', 'action': 'none'}, {'name': 'Unauthorized Content Type for Known URL', 'enabled': False, 'severity': 'low', 'action': 'none'}, {'name': 'Unauthorized Method for Known URL', 'enabled': False, 'severity': 'low', 'action': 'none
'}, {'name': 'Unauthorized SOAP Action', 'enabled': False, 'severity': 'high', 'action': 'none'}, {'name': 'Unauthorized URL Access', 'enabled': False, 'severity': 'high', 'action': 'block'}, {'name': 'Unknown Parameter', 'enabled': False, 'severity': 'informative',
'action': 'none'}, {'name': 'Unknown SOAP Element', 'enabled': False, 'severity': 'informative', 'action': 'none'}]
    ...
    def ApuConfig(self):
        ...
        >>> pol.ApuConfig
        {'SOAP Element Value Length Violation': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Parameter Read Only Violation': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, "Reuse of Expired Session's Cookie": {'enabled': True, 'source
s': 50, 'occurrences': 50, 'hours': 12}, 'SOAP Element Value Type Violation': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Required Parameter Not Found': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Unauthorized Method for
Known URL': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Unknown Parameter': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Parameter Type Violation': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Unautho
rized SOAP Action': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Unknown SOAP Element': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Required XML Element Not Found': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hour
s': 12}, 'Parameter Value Length Violation': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Cookie Injection': {'enabled': True, 'sources': 50, 'occurrences': 50, 'hours': 12}, 'Cookie Tampering': {'enabled': True, 'sources': 50, 'occurrences': 50
, 'hours': 12}}
        '''
